...
// import { behindTheSeenImages } from "../assets/behindTheSeenImages";
...
//         {behindTheSeenImages.map((image, index) => (
...
const BehindTheSeenGallery = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white p-10">
      <h1 className={`${styles.sectionHeadTextWorks}`}>Behind The Seen Gallery</h1>
...
export default BehindTheSeenGallery;
